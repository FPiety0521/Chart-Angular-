...
@Component({
  selector: 'app-am-chart-charts',
  templateUrl: './am-chart-charts.component.html',
  styleUrls: ['./am-chart-charts.component.css']
})
export class AmChartChartsComponent implements OnInit {
